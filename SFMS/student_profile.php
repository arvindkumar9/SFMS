...
<body>
	...
	<div class="col-md-4">
<?php $query = mysqli_query($conn, "SELECT * FROM `student` WHERE `stud_id` = '$_SESSION[student]'") or die(mysqli_error()); 	$fetch = mysqli_fetch_array($query);	?>
	...
	<center><h1 class="panel-title" style="color:red;">Student Profile</h1></center>
			...
			<div class="panel-body">
				...
				<form method="POST" enctype="multipart/form-data" action="save_file.php">
					<input type="file" name="file" size="6" style="background-color:#fff;" required="required" />
					<br />
	...
	$('#btn_yes').on('click', function(){
		...
		$.ajax({
			...
			success: function(data){
				...
				$(".del_file" + id).empty();
				$(".del_file" + id).html("<td colspan='4'><center class='text-danger'>Deleting...</center></td>"); setTimeout(function(){
				$(".del_file" + id).fadeOut('slow'); 	}, 1000);  }	}); }); }); </script>	
</body></html>